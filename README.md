...
***OFFENDER:"Full_Name_of_the_app"***

###**Second Step:**

On your computer, build a new file called by the name of the app in *'projects'>>>'offenders'*
...
If you have conclusive screenshots, which prove that the game is a copy of minetest, or a game using ***ilegally*** some stuff from our comunnity, post them! It will help the admin to see if the app is doing bad things!
